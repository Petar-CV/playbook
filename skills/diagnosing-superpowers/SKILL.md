...
description: Use when a superpowers session went wrong and your human partner wants to know why — repeated work, ignored plans, stumbles, poor results, a skill that didn't fire, "it took too long", "why is it so expensive", "what is it doing", for the current session or a past one identified by id or path, on any harness.
---
...
you do not diagnose superpowers. Whoever triages the report or the bundle
...
- **No superpowers diagnosis.** Report §7 states involvement and stops.
  ...
  pressing for a fix does not waive this; mention that a bundle is
  available on request. No advice to your
  partner either.
